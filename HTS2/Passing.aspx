        ...
        <div class="templatemo_post_text">
            ...
            <div style="float: right; margin-bottom: 50px;">
                ...
                <asp:Panel ID="pan_entry02" runat="server" Visible="false">
                    ...
                    <div runat="server" id="blinkText1">
                        <asp:Label ID="lbl_info0" runat="server" ForeColor="Maroon" Font-Size="12px"></asp:Label></div>
                </asp:Panel>
            </div>
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                ...
                <asp:View ID="View1" runat="server">
                    ...
                    <ajx:TabContainer ID="TabContainer1" runat="server"  Width="1060px" 
                        CssClass="ajax__tab_blueGrad-theme" ActiveTabIndex="1">
                        <ajx:TabPanel runat="server" ID="tpanel1" HeaderText="Passing Data">
                            <ContentTemplate>

                           
                               <asp:GridView ID="grid_pass1" runat="server" AllowPaging="True" 
                           AllowSorting="True" AutoGenerateColumns="False" CellPadding="2" 
                           DataKeyNames="ID_Pass" DataSourceID="SqlDS_truckpass" 
                           EmptyDataText="Sorry, Data Not Found" ForeColor="#333333" PageSize="25" 
                           ShowHeaderWhenEmpty="True" Width="860px">
                           ...
                           <Columns>
                               ...
                               <asp:BoundField DataField="ID_Pass" HeaderText="ID_Pass" 
                                   SortExpression="ID_Pass" Visible="False" />
                               <asp:BoundField DataField="TruckNo" HeaderText="TruckNo" 
                                   SortExpression="TruckNo" />
                               <asp:BoundField DataField="seamcargo" HeaderText="Raw Cargo" 
                                   SortExpression="seamcargo" />
                               <asp:BoundField DataField="SourceKode" HeaderText="ROM" 
                                   SortExpression="SourceKode" />
                               <asp:BoundField DataField="alamo" HeaderText="Raw Cargo" SortExpression="alamo">
                               <HeaderStyle BackColor="#FF9933" ForeColor="Black" />
                               </asp:BoundField>
                               <asp:BoundField DataField="Gross" DataFormatString="{0:N0}" HeaderText="Nett" 
                                   HtmlEncode="False" SortExpression="Gross">
                               <HeaderStyle BackColor="#FF9933" ForeColor="Black" />
                               </asp:BoundField>
                               <asp:BoundField DataField="TransactionDate" DataFormatString="{0:hh:mm tt}" 
                                   HeaderText="Km. 67" HtmlEncode="False" SortExpression="TransactionDate">
                               <ItemStyle HorizontalAlign="Right" />
                               </asp:BoundField>
                               <asp:BoundField DataField="TD_29Pass" DataFormatString="{0:hh:mm tt}" 
                                   HeaderText="Km. 29" HtmlEncode="False" SortExpression="TD_29Pass">
                               <ItemStyle HorizontalAlign="Right" />
                               </asp:BoundField>
                               <asp:BoundField DataField="TD_inQueue" DataFormatString="{0:hh:mm tt}" 
                                   HeaderText="Km. 2" HtmlEncode="False" SortExpression="TD_inQueue">
                               <ItemStyle HorizontalAlign="Right" />
                               </asp:BoundField>
                               <asp:BoundField DataField="DateClosed" DataFormatString="{0:hh:mm tt}" 
                                   HeaderText="Closed" HtmlEncode="False" SortExpression="DateClosed">
                               <ItemStyle HorizontalAlign="Right" />
                               </asp:BoundField>
                               <asp:TemplateField HeaderText="INFO">
                                   <ItemTemplate>
                                       <asp:HyperLink ID="HyperLink1" runat="server" class="blink" 
                                           NavigateUrl='<%# String.Concat("passentry1.aspx?v=1&idp=", Eval("ID_Pass"))%>' 
                                           onClick="window.open(this.href, this.target,'status=1,scrollbars=1,resizable=1,width=600,height=250,left=10,top=10'); return false" 
                                           Target='<%# "fltdev" & Eval("ID_Pass")%>' 
                                           Text='<%# cekData(Eval("blockrem"))%>'></asp:HyperLink>
                                       <asp:Label ID="Label6" runat="server" Text='<%# cekData(Eval("miss67"))%>'></asp:Label>
                                       <asp:Label ID="Label3" runat="server" class="blink" ForeColor="maroon" 
                                           Text='<%# cekData(Eval("block29"))%>'></asp:Label>
                                       <asp:Label ID="Label4" runat="server" class="blink" ForeColor="maroon" 
                                           Text='<%# cekData(Eval("blockQ"))%>'></asp:Label>
                           ...
                           <HeaderStyle BackColor="#507CD1" Font-Bold="False" Font-Names="Arial" 
                               Font-Size="7pt" Font-Underline="False" ForeColor="White" Height="35px" 
                        ...
                        <ajx:TabPanel runat="server" ID="tpanel2" HeaderText="Truck to ROM">
                            <ContentTemplate>
                                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" CellPadding="2" 
                        DataKeyNames="ID_RomDist" DataSourceID="ds_dist1" 
                        EmptyDataText="Sorry Data Not Found" ForeColor="#333333" PageSize="25" 
                        ShowHeaderWhenEmpty="True" Width="860px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ID_RomDist" HeaderText="ID_RomDist" 
                                InsertVisible="False" ReadOnly="True" SortExpression="ID_RomDist" 
                                Visible="False" />
                            <asp:BoundField DataField="TransactionDate" HeaderText="TransactionDate" 
                                SortExpression="TransactionDate" Visible="False" />
                            <asp:BoundField DataField="TransactionDate" DataFormatString="{0:hh:mm tt}" 
                                HeaderText="Time" HtmlEncode="False" SortExpression="TransactionDate">
                            <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TruckNo" HeaderText="TruckNo" 
                                SortExpression="TruckNo" />
                            <asp:BoundField DataField="MaterialKode" HeaderText="MaterialKode" 
                                SortExpression="MaterialKode" />
                        ...
                        <HeaderStyle BackColor="#336600" Font-Bold="False" Font-Names="Arial" 
                            Font-Size="7pt" Font-Underline="False" ForeColor="White" Height="35px" 
                            HorizontalAlign="Center" Wrap="False" />
                        ...
                        <SortedDescendingHeaderStyle BackColor="#009999" />
                                ...
                                <asp:SqlDataSource ID="ds_dist1" runat="server" 
            ...
            <div style="float: right; font-size: 10px; font-style: italic;">* UNS = Unschedulled Truck (Daily Quota)</div>
            <br />
...
SELECT [Kode] FROM [v_Sources]"></asp:SqlDataSource>
    ...
    <asp:GridView ID="grid_shadow1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDS_truckpass"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ID_Pass" HeaderText="ID_Pass" SortExpression="ID_Pass" Visible="False" />
            <asp:BoundField DataField="TransactionDate" DataFormatString="{0:MM/dd/yyyy}" HeaderText="TransactionDate" HtmlEncode="False" SortExpression="TransactionDate">
                <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
