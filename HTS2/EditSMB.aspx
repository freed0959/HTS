...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="Server">
    ...
    <div style="float: right; display: inline-block; margin-right: 90px;display:inline;z-index:5000;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <ajx:TabContainer runat="server" Width="1060px" ActiveTabIndex="0" CssClass="ajax__tab_blueGrad-theme" ID="tab29con">
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="grd_mtrSkmBlnd_K3" runat="server" DataSourceID="ds_SP_MtrSkmBlndg_K3" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TM" HeaderText="TM" SortExpression="TruckCount" NullDisplayText="-" DataFormatString="{0:N2}" HtmlEncode="False" />
                        <asp:BoundField DataField="ASH" HeaderText="ASH" SortExpression="TruckCount" NullDisplayText="-" DataFormatString="{0:N2}" HtmlEncode="False" />
                        <asp:BoundField DataField="TS" HeaderText="TS" SortExpression="TruckCount" NullDisplayText="-" DataFormatString="{0:N2}" HtmlEncode="False" />
                        <asp:BoundField DataField="CalAr" HeaderText="CalAr" SortExpression="TruckCount" NullDisplayText="-" DataFormatString="{0:N0}" HtmlEncode="False" />
                        <asp:TemplateField>
                            <HeaderTemplate>
...
SELECT CASE WHEN [Kode] IS NULL THEN a.MaterialKode ELSE m.Kode END as Kode 
FROM [v_Material] m
RIGHT OUTER JOIN 
( SELECT DISTINCT MaterialKode FROM dbo.tbl_ActMasterBlend) a ON m.Kode = a.MaterialKode
ORDER BY Kode"></asp:SqlDataSource>
