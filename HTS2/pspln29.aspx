        ...
        <ajx:TabPanel ID="bargetab1" runat="server" HeaderText="Barge Planning">
            <ContentTemplate>
                ...
                <asp:GridView ID="grd_brgPln" runat="server" AutoGenerateColumns="False" DataSourceID="ds_sp_brgPlnShf1"
                    ForeColor="#333333" Width="500px" DataKeyNames="id_PlnBrg" OnRowDataBound="grd_brgPln_RowDataBound" OnRowCommand="grd_brgPln_RowCommand" Style="margin-right: 0px" OnDataBound="grd_brgPln_DataBound">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
            ...
            <div class="PopupBody" style="background-color: #CCCCCC">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="dte_txt" runat="server" OnInit="dte_txt_Init"></asp:TextBox>
